...
// Tickets
import ListTickets from 'src/pages/Tickets/ListTickets.vue';
import ListNotifications from 'src/pages/Notifications/ListNotifications.vue';
import NewTicket from 'src/pages/Tickets/NewTicket.vue';
import EditTicket from 'src/pages/Tickets/EditTicket.vue';
import NewTicketUser from 'src/pages/Tickets/NewTicketUser.vue';
import EditTicketUser from 'src/pages/Tickets/EditTicketUser.vue';
...
// Search Satisfaction
import SearchSatisfaction from "src/pages/Tickets/SearchSatisfaction.vue";
